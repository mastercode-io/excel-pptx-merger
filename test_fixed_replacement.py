#!/usr/bin/env python3
"""
Test script to verify the fixed merge field replacement works correctly.
"""

import logging
from fixed_merge_replacement import FixedPowerPointProcessor
from debug_merge_fields import MockParagraph, test_scenario

# Set up logging
logging.basicConfig(level=logging.INFO)

def test_fixed_scenarios():
    """Test the fixed replacement logic against problematic scenarios."""
    
    print("TESTING FIXED REPLACEMENT LOGIC")
    print("=" * 60)
    ...
    processor = FixedPowerPointProcessor()
...
if __name__ == "__main__":
    all_passed = test_fixed_scenarios()
    if all_passed:
