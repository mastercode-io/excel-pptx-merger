...
class GraphAPIConfig:
    ...
    def _load_from_file(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Failed to load Graph API config file {self.config_file}: {e}")
    ...
    def _load_from_env(self) -> None:
        ...
        self._settings = {
            ...
            "temp_cleanup": os.getenv("RANGE_EXPORT_TEMP_CLEANUP", "true").lower() == "true"
        }
    ...
    def validate_config(self) -> tuple[bool, list[str]]:
        ...
        if self._settings.get("default_dpi", 0) < 72 or self._settings.get("default_dpi", 0) > 600:
